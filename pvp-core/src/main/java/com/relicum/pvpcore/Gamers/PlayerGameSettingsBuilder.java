...
public class PlayerGameSettingsBuilder {
    ...
    public PlayerGameSettings build() {
        return new PlayerGameSettings(allowedFlight, displayName, exhaustion, fireTicks, flySpeed, foodLevel, gameMode, isFlying, level, playerHealth, saturation, totalExperience, walkSpeed, xp);
    }
}
