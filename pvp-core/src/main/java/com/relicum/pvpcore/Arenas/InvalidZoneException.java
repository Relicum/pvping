...
/**
 * Name: InvalidZoneException.java Created: 01 May 2015
 *
 * @author Relicum
 * @version 0.0.1
 */
public class InvalidZoneException extends Exception {
     ...
     * @since 1.4
     */
    public InvalidZoneException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.4
     */
    public InvalidZoneException(String message, Throwable cause) {
        super(message, cause);
    }
